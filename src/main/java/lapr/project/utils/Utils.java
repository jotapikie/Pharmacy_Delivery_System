...
public class Utils {
  ...
  public static double distance(double lat1, double lat2, double lon1,
    ...
    public static double pathEnergyCostScooter(double totalWeight, double kineticCoef, double vehicleAerodynamicCoef, double windToPath, double altitudeDif, double distance) {
    ...
    public static double pathEnergyCostDrone(double totalWeight, double vehicleAerodynamicCoef, double powerTransfer, double liftDrag, double consumoEletronico, double areaFrontal, double areaTopo, double velocidadeMedia, double velocidadeVertical, Wind windToPath, double altitudeDifI, double altitudeDifF, double distance) {
        ...
        double fAero = Math.abs(0.5 * Constants.RO_AR * vehicleAerodynamicCoef * areaFrontal * windToPath.vx * windToPath.vx) + Math.abs(0.5 * Constants.RO_AR * vehicleAerodynamicCoef * areaFrontal * windToPath.vy * windToPath.vy) + Math.abs(0.5 * Constants.RO_AR * vehicleAerodynamicCoef * areaTopo * windToPath.vz * windToPath.vz);
