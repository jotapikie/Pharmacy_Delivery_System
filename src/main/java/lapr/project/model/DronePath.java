...
public class DronePath extends Pathway{
    ...
    public DronePath(double totalWeight, GeographicalPoint origLocation, GeographicalPoint destLocation, StreetType type, double distance, double wind, String street) {
