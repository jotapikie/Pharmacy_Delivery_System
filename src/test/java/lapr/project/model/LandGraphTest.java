...
public class LandGraphTest {
    ...
    public static void setUpClass() {
        ...
        path1 = new Pathway(p1, p2, StreetType.ASPHALT, 200, 0.4, "Street1");
        path2 = new Pathway(p2, p3, StreetType.ASPHALT, 100, 0.4, "Street2");
        path3 = new Pathway(p3, p4, StreetType.ASPHALT, 50, 0.4, "Street3");
        path4 = new Pathway(p4, p5, StreetType.ASPHALT, 70, 0.4, "Stree4");
        path5 = new Pathway(p5, p6, StreetType.ASPHALT, 80, 0.4, "Street5");
        path6 = new Pathway(p6, p7, StreetType.ASPHALT, 90, 0.4, "Street6");
        path7 = new Pathway(p7, p8, StreetType.ASPHALT, 100, 0.4, "Street7");
        path8 = new Pathway(p8, p1, StreetType.ASPHALT, 300, 0.4, "Street8");
        path9 = new Pathway(p3, p9, StreetType.ASPHALT, 50, 0.4, "Street9");
        path10 = new Pathway(p9, p4, StreetType.ASPHALT, 70, 0.4, "Stree10");
        path11 = new Pathway(p4, p7, StreetType.ASPHALT, 40, 0.4, "Street11");
        path12 = new Pathway(p7, p1, StreetType.ASPHALT, 70, 0.4, "Street12");
