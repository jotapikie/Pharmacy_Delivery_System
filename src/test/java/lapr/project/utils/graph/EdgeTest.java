...
public class EdgeTest {
 ...
 Edge<String, String> instance = new Edge<>() ;
	...
	assertTrue(instance.equals(instance.clone()));
        ...
        assertFalse(instance.equals(vertex1));
        
        Edge<String, String> temp = new Edge<>() ;
        temp.setVOrig(vertex1);
        assertFalse(instance.equals(temp));
        temp = new Edge<>();
        temp.setVDest(vertex1);
        assertFalse(instance.equals(temp));
        temp = new Edge<>();
        temp.setWeight(67);
        assertFalse(instance.equals(temp));
        temp = new Edge<>();
        temp.setElement("sadasff");
        Edge<String, String> temp1 = new Edge<>() ;
        temp1.setElement("aaaaa");
    ...
    public void testClone() {
        ...
        assertTrue(otherEdge.getElement().equals(instClone.getElement()));
