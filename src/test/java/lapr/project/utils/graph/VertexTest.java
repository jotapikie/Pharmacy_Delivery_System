...
public class VertexTest {
   ...
   static Vertex<String, Integer> instance1 = new Vertex<>() ;
   static Vertex<String, Integer> instance2;
   ...
   @BeforeAll
    public static void setUpClass() {
       instance1.addAdjVert("sdf", new Edge<>());
       instance1.addAdjVert("ssdf", new Edge<>());
       instance1.addAdjVert("gfdg", new Edge<>());
       instance2 = new Vertex<>(instance1);
    }
	...
	assertTrue(instance.equals(instance.clone()));
        ...
        assertFalse(instance.equals(edge2));
        
        Vertex<String, Integer> v1 = new Vertex<>() ;
        Vertex<String, Integer> v2 = new Vertex<>() ;
        v1.setElement("A");
        v2.setElement("B");
