...
BEGIN
    OPEN cur_orders FOR
            ...
            WHERE o.client_email = c.email AND c.longitude = g.longitude AND c.latitude = g.latitude AND a.longitude = g.longitude AND a.latitude = g.latitude AND o.status = p_status AND o.pharmacy_id = p_pharmacy_id;
